...
export const LABEL_CANDIDATE_ANGLES = 16
export const LABEL_MAX_DISTANCE_FACTOR = 1.35
export const LABEL_DISTANCE_STEPS = 4
export const LABEL_ZOOM_BASE_COUNT = 12
export const LABEL_ZOOM_ADD_PER_LEVEL = 6
export const LABEL_BG_OPACITY_INSIDE_HULL = 0.88
...
export const LABEL_PILL_BORDER_COLOR = '#e8e8e8'
export const LABEL_PILL_BORDER_WIDTH = 0.5
